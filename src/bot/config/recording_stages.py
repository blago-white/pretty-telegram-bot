...
TYPE_RECORDING_BY_STATE_GROUP = {
    'InitialRegistration': 'int',
    'AccountRegistration': 'acc',
    'WishesRegistration': 'fnd'
}
...
NAME_WISH_COLUMN_BY_RECORD_STAGE = {
...
RECORDING_TYPES_WITH_SAVING_USER_PHOTO = TYPE_RECORDING[0],

RECORDING_TYPES_WITH_UPDATING_USER_PHOTO = TYPE_RECORDING[1], TYPE_RECORDING[2]
